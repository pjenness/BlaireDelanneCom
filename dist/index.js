...
function getLocalImagePath(remoteUrl) {
...
var MemStorage = class {
  ...
  contactSubmissionId;
  constructor() {
    this.postsData = /* @__PURE__ */ new Map();
    this.galleryImagesData = /* @__PURE__ */ new Map();
    this.commentsData = /* @__PURE__ */ new Map();
    this.subscribersData = /* @__PURE__ */ new Map();
    this.contactSubmissionsData = /* @__PURE__ */ new Map();
    this.postId = 1;
  ...
  async getFeaturedPosts(limit) {
    const featuredPosts = Array.from(this.postsData.values()).filter((post) => post.featured !== null && post.featured > 0).sort((a, b) => (b.featured ?? 0) - (a.featured ?? 0));
    return limit ? featuredPosts.slice(0, limit) : featuredPosts;
  }
  async getRecentPosts(limit) {
    const allPosts = Array.from(this.postsData.values()).sort((a, b) => new Date(b.publishedAt).getTime() - new Date(a.publishedAt).getTime());
  ...
  async createPost(post) {
    ...
    const newPost = {
      ...post,
      id,
      publishedAt: post.publishedAt || /* @__PURE__ */ new Date(),
  ...
  async getFeaturedGalleryImages() {
    return Array.from(this.galleryImagesData.values()).filter((image) => image.featured !== null && image.featured > 0).sort((a, b) => (b.featured ?? 0) - (a.featured ?? 0));
  }
  async createGalleryImage(image) {
    ...
    const newImage = {
      ...
      createdAt: image.createdAt || /* @__PURE__ */ new Date(),
  ...
  async getCommentsByPostId(postId) {
    return Array.from(this.commentsData.values()).filter((comment) => comment.postId === postId).sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
  }
  ...
  async createSubscriber(subscriber) {
    const existingSubscriber = Array.from(this.subscribersData.values()).find((sub) => sub.email.toLowerCase() === subscriber.email.toLowerCase());
  ...
  initializeData() {
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2025-05-12T10:00:00Z"),
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2023-06-20T10:00:00Z"),
      category: "Fashion",
      location: "New Zealand",
      featured: 3,
      readTime: 8,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2022-10-15T10:00:00Z"),
      category: "Wedding",
      location: "New Zealand",
      featured: 2,
      readTime: 7,
    ...
    this.createPost({
      ...
      <ul class="list-disc pl-6 my-4">
        <li class="mb-2"><strong>Novel Materials:</strong> Innovations like Pi\xF1atex (pineapple leaf fiber leather alternative), Mylo (mushroom mycelium leather), and Econyl (regenerated nylon from ocean waste) offer more sustainable alternatives to conventional textiles.</li>
      ...
      publishedAt: /* @__PURE__ */ new Date("2021-04-10T10:00:00Z"),
      category: "Hospitality",
      location: "Australia",
      featured: 1,
      readTime: 9,
    ...
    this.createPost({
      ...
      <p><strong>Louis Vuitton</strong> introduced a series of pieces featuring digital displays woven directly into traditional fabrics, creating garments capable of changing patterns throughout the day. Nicolas Ghesqui\xE8re described these as "responsive clothing" that adapts to the wearer's environment or preferences.</p>
      ...
      <p><strong>Comme des Gar\xE7ons'</strong> Rei Kawakubo sent conceptual pieces down the runway that defied categorization as conventional clothing\u2014sculptural constructions that encased the body in abstract forms made from unexpected materials including industrial rubber, synthetic hair, and paper-like textiles. The collection reasserted fashion's status as wearable art capable of communicating complex ideas beyond verbal expression.</p>
      ...
      publishedAt: /* @__PURE__ */ new Date("2020-08-15T10:00:00Z"),
      category: "Travel",
      location: "Australia",
      featured: 0,
      readTime: 10,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2023-06-18T10:00:00Z"),
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2023-06-14T10:00:00Z"),
      category: "Industry",
      featured: 0,
      readTime: 11,
      prevPostId: 5,
    ...
    this.createPost({
      ...
      <p><strong>R\xF3is\xEDn Pierce,</strong> the Irish designer, creates ethereal white garments using traditional Irish textile techniques like smocking, shirring, and crochet. Her work elevates overlooked "women's work" crafts to high fashion through extraordinary technical execution and conceptual depth.</p>
      ...
      publishedAt: /* @__PURE__ */ new Date("2023-06-12T10:00:00Z"),
      category: "Designers",
      featured: 0,
      readTime: 10,
      prevPostId: 6,
    ...
    this.createGalleryImage({
      ...
      featured: 3,
      createdAt: /* @__PURE__ */ new Date("2023-06-20T10:00:00Z")
    });
    this.createGalleryImage({
      ...
      featured: 2,
      createdAt: /* @__PURE__ */ new Date("2023-06-18T10:00:00Z")
    });
    this.createGalleryImage({
      ...
      featured: 1,
      createdAt: /* @__PURE__ */ new Date("2023-06-15T10:00:00Z")
    });
    this.createGalleryImage({
      ...
      featured: 4,
      createdAt: /* @__PURE__ */ new Date("2023-06-12T10:00:00Z")
    });
    this.createGalleryImage({
      ...
      featured: 5,
      createdAt: /* @__PURE__ */ new Date("2023-06-10T10:00:00Z")
    });
    this.createGalleryImage({
      ...
      featured: 6,
      createdAt: /* @__PURE__ */ new Date("2023-06-05T10:00:00Z")
    });
    this.createGalleryImage({
      ...
      featured: 0,
      createdAt: /* @__PURE__ */ new Date("2023-06-02T10:00:00Z")
    });
    this.createGalleryImage({
      ...
      featured: 0,
      createdAt: /* @__PURE__ */ new Date("2023-05-28T10:00:00Z")
    });
    this.createGalleryImage({
      title: "Color Theory",
      imageUrl: "/images/gallery/fashion-editorial-1.jpg",
      ...
      featured: 0,
      createdAt: /* @__PURE__ */ new Date("2023-05-25T10:00:00Z")
    });
    this.createGalleryImage({
      ...
      tags: "#Vintage #Retro",
      featured: 0,
      createdAt: /* @__PURE__ */ new Date("2023-05-20T10:00:00Z")
    });
    this.createGalleryImage({
      ...
      featured: 0,
      createdAt: /* @__PURE__ */ new Date("2023-05-18T10:00:00Z")
    });
    this.createGalleryImage({
      title: "Autumn Layers",
      imageUrl: "/images/gallery/luxury-hotel-1.jpg",
      tags: "#Autumn #Layers",
      featured: 0,
      createdAt: /* @__PURE__ */ new Date("2023-05-15T10:00:00Z")
    });
    this.createComment({
      postId: 1,
      name: "Sarah Johnson",
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2019-02-15T10:00:00Z"),
      category: "Hospitality",
      location: "New York",
      featured: 0,
      readTime: 4,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2019-04-10T10:00:00Z"),
      category: "Wedding",
      location: "New York",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2019-05-22T10:00:00Z"),
      category: "Personal",
      location: "New York",
      featured: 0,
      readTime: 3,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2019-07-08T10:00:00Z"),
      category: "Hospitality",
      location: "New York",
      featured: 0,
      readTime: 4,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/sydney-culinary-treasures.jpg",
      publishedAt: /* @__PURE__ */ new Date("2019-09-12T10:00:00Z"),
      category: "Fashion",
      location: "New York",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/new-zealand-adventure.jpg",
      publishedAt: /* @__PURE__ */ new Date("2019-12-05T10:00:00Z"),
      category: "Hospitality",
      location: "New York",
      featured: 0,
      readTime: 6,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/moving-to-sydney.jpg",
      publishedAt: /* @__PURE__ */ new Date("2020-01-20T10:00:00Z"),
      category: "Personal",
      location: "New York",
      featured: 0,
      readTime: 4,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/sydney-culinary-treasures.jpg",
      publishedAt: /* @__PURE__ */ new Date("2020-03-10T10:00:00Z"),
      category: "Travel",
      location: "Australia",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2020-06-18T10:00:00Z"),
      category: "Hospitality",
      location: "Australia",
      featured: 0,
      readTime: 6,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/autumn-harvest-festivals-otago.jpg",
      publishedAt: /* @__PURE__ */ new Date("2020-08-14T10:00:00Z"),
      category: "Travel",
      location: "Australia",
      featured: 0,
      readTime: 4,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/byron-bay-weddings.jpg",
      publishedAt: /* @__PURE__ */ new Date("2020-10-25T10:00:00Z"),
      category: "Wedding",
      location: "Australia",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/sydney-culinary-treasures.jpg",
      publishedAt: /* @__PURE__ */ new Date("2020-12-20T10:00:00Z"),
      category: "Personal",
      location: "Australia",
      featured: 0,
      readTime: 4,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/accessories-styling.jpg",
      publishedAt: /* @__PURE__ */ new Date("2021-02-05T10:00:00Z"),
      category: "Hospitality",
      location: "Australia",
      featured: 0,
      readTime: 4,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/byron-bay-weddings.jpg",
      publishedAt: /* @__PURE__ */ new Date("2021-04-12T10:00:00Z"),
      category: "Wedding",
      location: "Australia",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/sustainable-fashion.jpg",
      publishedAt: /* @__PURE__ */ new Date("2021-06-30T10:00:00Z"),
      category: "Hospitality",
      location: "Australia",
      featured: 0,
      readTime: 4,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/wellness-event-design.jpg",
      publishedAt: /* @__PURE__ */ new Date("2021-08-10T10:00:00Z"),
      category: "Travel",
      location: "Australia",
      featured: 0,
      readTime: 4,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/luxury-wedding-planning.jpg",
      publishedAt: /* @__PURE__ */ new Date("2021-10-18T10:00:00Z"),
      category: "Hospitality",
      location: "Australia",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/moving-to-sydney.jpg",
      publishedAt: /* @__PURE__ */ new Date("2021-12-05T10:00:00Z"),
      category: "Personal",
      location: "Australia",
      featured: 0,
      readTime: 4,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/new-zealand-adventure.jpg",
      publishedAt: /* @__PURE__ */ new Date("2022-01-20T10:00:00Z"),
      category: "Travel",
      location: "New Zealand",
      featured: 0,
      readTime: 4,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/luxury-travel.jpg",
      publishedAt: /* @__PURE__ */ new Date("2022-03-08T10:00:00Z"),
      category: "Personal",
      location: "New Zealand",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      coverImage: "/images/blog/sustainable-fashion.jpg",
      publishedAt: /* @__PURE__ */ new Date("2022-05-12T10:00:00Z"),
      category: "Hospitality",
      location: "New Zealand",
      featured: 0,
      readTime: 6,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2022-07-25T10:00:00Z"),
      category: "Wedding",
      location: "New Zealand",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2022-09-14T10:00:00Z"),
      category: "Travel",
      location: "New Zealand",
      featured: 0,
      readTime: 4,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2022-11-10T10:00:00Z"),
      category: "Hospitality",
      location: "New Zealand",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2022-12-28T10:00:00Z"),
      category: "Personal",
      location: "New Zealand",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2023-08-14T10:00:00Z"),
      category: "Wedding",
      location: "New Zealand",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2023-11-05T10:00:00Z"),
      category: "Travel",
      location: "New Zealand",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2024-02-20T10:00:00Z"),
      category: "Hospitality",
      location: "New Zealand",
      featured: 0,
      readTime: 4,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2024-06-15T10:00:00Z"),
      category: "Hospitality",
      location: "New Zealand",
      featured: 0,
      readTime: 5,
    ...
    this.createPost({
      ...
      publishedAt: /* @__PURE__ */ new Date("2025-01-10T10:00:00Z"),
      category: "Travel",
      location: "New Zealand",
      featured: 0,
      readTime: 6,
...
var contactFormSchema = createInsertSchema(contactSubmissions).pick({
  name: true,
  email: true,
  subject: true,
  message: true
...
async function registerRoutes(app2) {
  ...
  app2.get("/api/posts/featured/main", async (req, res) => {
    try {
      const posts2 = await storage.getFeaturedPosts(1);
      res.json(posts2[0] || null);
    } catch (error) {
